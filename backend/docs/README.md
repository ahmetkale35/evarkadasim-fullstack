...
| 2 | [02-API-REFERENCE.md](./02-API-REFERENCE.md) | **14 endpoint**: Property API eklendi. request/response JSON örnekleri, query parametreleri, hata kodları tablosu |
...
| 4 | [04-BUSINESS-LOGIC.md](./04-BUSINESS-LOGIC.md) | Auth akışı satır satır, Property CRUD ve filtreleme (yeni), Swipe/match 7 adım detaylı, uyumluluk formülü, feed sıralama, test sistemi |
| 5 | [05-SECURITY-AND-DEV-GUIDE.md](./05-SECURITY-AND-DEV-GUIDE.md) | Güvenlik (auth akışı, IDOR koruması-yeni, şifre hashleme), performans (AsNoTracking, N+1), yeni özellik ekleme adım adım, paket listesi |
